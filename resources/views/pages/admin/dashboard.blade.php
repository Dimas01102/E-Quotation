...
<div class="p-6">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-6">
        ...
        <div class="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 p-5">
            ...
            <p class="text-xs text-gray-500 mt-0.5">Total Quotation</p>
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm">
                    <thead><tr class="border-b border-gray-100 dark:border-gray-800">
                        <th class="px-5 py-3 text-left text-xs font-semibold text-gray-500">No. RFQ</th>
                    ...
                    <tbody id="recent-batch-body">
                        <tr><td colspan="4" class="px-5 py-8 text-center text-sm text-gray-400">Memuat...</td></tr>
                    </tbody>
                </table>
            </div>
        </div>
    ...
    try {
        ...
        bBody.innerHTML = batches.length
            ...
            <tr class="border-b border-gray-50 dark:border-gray-800/50 hover:bg-gray-50 dark:hover:bg-gray-800/30">
                <td class="px-5 py-3.5"><a href="/admin/batches/${b.id_batch}" class="text-xs font-bold text-blue-600 hover:underline">${b.batch_number}</a></td>
